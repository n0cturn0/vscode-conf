...
?>
  ...
  <body>
    ...
    <style>
      /* Estilize o texto dentro do slider */
.swiper-slide-caption {
  position: absolute;
  top: 30%; /* Ajuste este valor conforme necessário para mover o texto para cima ou para baixo */
  left: 50%; /* Centraliza horizontalmente, ajuste conforme necessário */
  transform: translate(-50%, 0); /* Centraliza horizontalmente com base no ponto médio do texto */
  width: 100%; /* Garante que o texto ocupe toda a largura do slide */
}
...
/* Estilize o texto pequeno */
.swiper-slide-caption p {
  font-size: 1.2em; /* Ajuste o tamanho da fonte conforme necessário */
}

/* Outros estilos para o slider, se necessário */
.swiper-container {
