...
class SiteController extends Controller
{
    ...
    public function cadastracv(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('vaga', ['id' => $id])->with('success', 'Destaque da página inicial alterado com sucesso!');
            ...
            DB::insert($query, [ $request->input('idvaga'), $request->input('nome'),$nomeAleatorio ]);
