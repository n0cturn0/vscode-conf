            ...
            if ($conta_grupo === 0) {
               ...
               if ($contatipo >= 0) {
                  ...
                  if (!empty($computadores)) {
                     ...
                     $consultalacre = $DB->query("SELECT items_id, tickets_id, glpi_computer_lacre_hystori.status, glpi_computer_lacre_hystori.lacre_number, glpi_computer_lacre_hystori.id
