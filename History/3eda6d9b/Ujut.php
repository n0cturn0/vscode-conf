               ...
               if ($contatipo >= 0) {
                  ...
                  if (!empty($computadores)) {
                     ...
                     if ($rowcount == 0) {
                        ...
                        echo "<br>";
                        echo "<input type='checkbox' checked name='lacre' id='lacre'>$rowcount Lacre(s) validado(s)<a href='" . $CFG_GLPI["root_doc"] . "/plugins/psglacre/front/maketab.form.php?ticket_id=" . $ticket_id . "'><span class='fa fa-desktop' style='font-size: 15px; color: blue;'></span></a>";
                       
                        // echo "<br><a href='" . $CFG_GLPI["root_doc"] . "/plugins/psglacre/front/maketab.form.php?ticket_id=" . $ticket_id . "' class='vsubmit' style='margin-top: 10px;'>" . _sx('button', 'Validar esse chamado novamente') . "</a>";
