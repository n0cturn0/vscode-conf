               ...
               if ($contatipo >= 0) {
                  ...
                  if (!empty($computadores)) {
                     ...
                     if ($rowcount == 0) {
                        ...
                        echo "<br><a href='" . $CFG_GLPI["root_doc"] . "/plugins/psglacre/front/maketab.form.php?ticket_id=" . $ticket_id . "'><span class='fa fa-desktop' style='font-size: 15px; color: blue;'></span></a>";
