    ...
    {{--                                                </div>--}}
                                            ...
                                            @foreach($vagas as $values)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h4>{{$values->vaga}}</h4><hr><p>{{$values->descricao}}</p>
                                                    </td>

                                                    <td>
                                                        <!-- @if($values->perfil == 0) -->
                                                        <a href="{{url('perfil/')}}"  class="btn btn-block btn-success btn-xs">Perfil</a>
                                                        <!-- @endif -->
                                                        <a href="{{url('produtoimage/')}}"  class="btn btn-block btn-info btn-xs">Adicionar Imagens</a>
                                                        <a href="{{url('showproduto/')}}"  class="btn btn-block btn-info btn-xs">Ver imagens</a>
                                                        <a href="{{url('apagarproduto/')}}"  class="btn btn-block btn-danger btn-xs">Apagar produto</a>
