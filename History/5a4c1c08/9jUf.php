...
Route::get('/vaga', [\App\Http\Controllers\SiteController::class,'vaga'])->name('vaga');
...
Route::get('/admcolaboradores', [App\Http\Controllers\HomeController::class, 'colaboradores'])->name('categoria');
