...
Route::post('/cadastracv', [\App\Http\Controllers\SiteController::class,'cadastracv'])->name('cadastracv');
Route::get('/deparacurriculo/{id}', [\App\Http\Controllers\HomeController::class,'deparacurriculo'])->name('deparacurriculo');
