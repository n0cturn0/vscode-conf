...
function plugin_psglacre_install()
{
  ...
  $DB->query($altertable_computer_lacre) or die("Error altering table glpi_computers_lacre: " . $DB->error());
  ...
  if (!TableExists("glpi_computers_lacre_justificativa")) {
    ...
    $insert = "INSERT INTO glpi_computers_lacre_justificativa (justificativa, observacao) VALUES 
                 ('Equipamento sem garantia', 0),
                 ('Equipamento sem conserto', 0),
                 ('Equipamento impossibilitado de lacre', 1)";
