         ...
         case 'justificar':
            ...
            $justifica_lacre = "
                     ...
                     SET
                        computer_id = '$computer_id',
                        status = 99,
                        nlacre = " . (isset($_POST['numero_lacre'][$computer_id]) ? "'" . $_POST['numero_lacre'][$computer_id] . "'" : "NULL") . ",
                        justificativas_id = '" . ($_POST['justificativas_id']) . "',
                        id_ticket = $id_ticket,
                        texto_justificativo = '" . $_POST['texto_justificativo'] . "',
                  ";
