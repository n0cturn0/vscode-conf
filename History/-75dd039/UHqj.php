...
class PluginPsglacreMaketab extends CommonDBTM
{
   ...
   static function displayTab($item)
   {
      ...
      glpi_computers.id = glpi_computer_lacre_hystori.computer_id
      where computer_id = " . $computador . " ORDER BY glpi_computer_lacre_hystori.id DESC");
         ...
         case 'justificar':
            ...
            $justifica_lacre = "
                     ...
                     SET
                        ...
                        nlacre ='SEM LACRE',
                        id_ticket = $id_ticket,
                        justificativas_id = '" . $_POST['justificativa_id'] . "',
