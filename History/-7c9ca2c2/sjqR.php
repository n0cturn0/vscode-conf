               ...
               <tr class="noHover">
                  ...
                  <?php if (!empty($numero_lacre)) { ?>
                     <th colspan="<?php echo (!empty($numero_lacre)) ? '4' : '8'; ?>">
                        ...
                        <input name="acao_lacre[<?php echo  $value[$i]; ?>]" id="radioAssinar" type="radio" name="acao_lacre[<?php echo  $value[$i]; ?>]" value="justificar" class="acao_lacre">
                  ...
                  <th id="opcoesAssinatura" class="hidden">
                     ...
                     <div id="campoTexto" class="hidden">
                        <label>
                           Digite o motivo:
                           <textarea name="texto_justificativo" id="texto_justificativo" rows="4" cols="30"></textarea>
                        </label>
                     </div>
                  </th>
               </tr>
   ...
   <script type="text/javascript">
      $(".acao_lacre").click(function() {
         ...
         if ($(this).val() === 'validar') {
            ...
            numeroLacreLabel.text('Sem lacre');
