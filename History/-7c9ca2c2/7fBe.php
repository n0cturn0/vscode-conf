         ...
         ?>
               <tr class="noHover">
                  ...
                  <th colspan="<?php echo (!empty($numero_lacre)) ? '4' : '4'; ?>">
                     ...
                     <input onclick="mostrarOpcoes()" name="acao_lacre[<?php echo $value[$i]; ?>]" id="radioAssinar" type="radio" value="justificar" class="acao_lacre">
   ...
   <script type="text/javascript">
      $(".acao_lacre").click(function() {
         ...
         if ($(this).val() === 'validar') {
            ...
            numeroLacreInput.hide().val('0000001');
