...
<body>
   ...
   <script>
      function mostrarOpcoes() {
         ...
         var radioAssinar = document.getElementById("radioAssinar_" + i);
         var numeroLacreInput = document.getElementById("lacre_" + i);
         var labelLacre = document.getElementById("labelLacre_" + i);
